  ...
  <Menu as='div' className='relative text-left w-26'>
    {({ open }) => (
      <>
        ...
        >
          <Menu.Items className='md:absolute flex flex-row items-center mt-2 md:-mt-14 md:ml-28 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none cursor-pointer'>
            {langs.map((title, key) => (
